...
INSERT INTO public.types VALUES (1, 'Hallo');
INSERT INTO public.types VALUES (2, 'tschüss');
INSERT INTO public.types VALUES (3, 'tschau');
...
--
-- Name: elements r1; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT r1 UNIQUE (symbol);


--
-- Name: elements r2; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
